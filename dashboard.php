...
<div class="container mx-auto px-4 py-6">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 text-center">
    ...
    <a href="statis.php" class="block bg-pink-700 hover:bg-gray-800 text-white py-3 sm:py-4 px-4 sm:px-6 rounded-xl text-base sm:text-lg font-semibold transition">
      📊 Lihat Lengkap
    </a>
  </div>
