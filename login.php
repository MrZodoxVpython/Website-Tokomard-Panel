...
<p class="text-sm mb-2">Atau login dengan</p>
<a href="google-login.php?mode=login" class="inline-flex items-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-md">
