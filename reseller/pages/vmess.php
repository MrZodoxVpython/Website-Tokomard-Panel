...
<div class="mb-6">
    <h2 class="text-2xl font-semibold mb-2">🌐 Daftar Produk Vmess</h2>
    ...
    <?php foreach ($sshProducts as $product): ?>
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-4 border border-gray-200 dark:border-gray-700">
            ...
            <div class="flex gap-2">
                ...
                <a href="/reseller/pages/co-vmess.php" class="px-3 py-1 bg-green-600 hover:bg-green-500 text-white text-xs rounded shadow <?= $product['available'] ? '' : 'opacity-50 pointer-events-none' ?>">🛒 Keranjang</a>
            </div>
        </div>
    <?php endforeach; ?>
</div>
