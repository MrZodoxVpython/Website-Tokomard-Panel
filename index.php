...
<body class="bg-gray-900 text-white font-sans">
  ...
  <section class="text-center py-12 px-4 max-w-4xl mx-auto">
    ...
    <!-- Slider -->
    <div x-data="{ activeSlide: 0, slides: ['https://i.imgur.com/8IiXQqY.png', 'https://i.imgur.com/q3DzxiB.png', 'https://i.imgur.com/8IiXQY.png'] }" class="relative w-full overflow-hidden rounded-xl shadow-lg max-w-3xl mx-auto">
