...
if (isset($_POST['toggle_user']) && isset($_POST['action'])) {
    ...
    header("Location: show-vless-rw-mard.php");
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['edit_user'])) {
	...
	$cmds[] = "$sshPrefix \"sed -i 's|^#&[[:space:]]*$escapedUser[[:space:]]*[0-9-]*|#& $user $expired|' $configPath\"";
...
<head>
    <meta charset="UTF-8">
    <title>Vless RW-MARD</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-900 text-white min-h-screen p-6">
<div class="max-w-5xl mx-auto">
    <h1 class="text-center text-2xl font-bold mb-6">Daftar Vless (RW-MARD) – <?=htmlspecialchars($reseller)?></h1>
