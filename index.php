...
<body class="bg-gray-950 text-gray-200 font-sans">
  ...
  <section class="text-center px-4 py-16 max-w-4xl mx-auto">
    ...
    <div
      ...
      class="relative w-full overflow-hidden rounded-xl shadow-xl max-w-3xl mx-auto"
    >
      ...
      <div class="absolute inset-0 flex items-center justify-between px-4">
        <button @click="active = (active - 1 + images.length) % images.length" class="bg-gray-800 bg-opacity-50 hover:bg-opacity-70 text-white text-2xl p-2 rounded-full">&#10094;</button>
        <button @click="active = (active + 1) % images.length" class="bg-gray-800 bg-opacity-50 hover:bg-opacity-70 text-white text-2xl p-2 rounded-full">&#10095;</button>
      </div>
    </div>
  </section>
