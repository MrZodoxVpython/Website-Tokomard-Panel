...
if (php_sapi_name() === 'cli') {
    if ($argc < 5) {
        ...
        echo "Gunakan: php add-shadowsocks.php username expired password reseller\n";
        exit(1);
    }
...
$jsonLine = "},{\"password\": \"$uuid\", \"email\": \"$username\"";
$tags = ['ss', 'ssgrpc'];

// Proses penambahan akun
$hasil = prosesXray('shadowsocks', $tags, $commentLine, $jsonLine, $username, $expired, $uuid, $reseller);
