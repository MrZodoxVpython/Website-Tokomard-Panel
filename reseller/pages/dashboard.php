...
<!-- Tampilan Statistik -->
<div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2 sm:gap-4 mb-4 text-center">
<?php
    ...
    <table class="w-full text-[11px] sm:text-sm text-left text-gray-800 dark:text-white table-fixed">
      <thead class="bg-gray-100 dark:bg-gray-700">
        <tr>
          ...
          <th class="px-2 md:px-4 py-2 w-[10%]">Protocol</th>
          <th class="px-2 md:px-4 py-2 w-[15%]">Expired</th>
          <th class="px-2 md:px-4 py-2 w-[35%]">UUID/Pass</th>
