...
<div class="flex flex-col md:flex-row min-h-screen">
  ...
  <!-- SIDEBAR -->
  <aside class="w-full md:w-64 bg-white dark:bg-gray-800 p-4 border-b md:border-r border-gray-200 dark:border-gray-700">
    <div class="flex flex-col items-center">
      ...
      <h2 class="text-base font-semibold mb-4">@<?= htmlspecialchars($reseller) ?></h2>
    </div>
    ...
    <nav class="space-y-2 text-sm">
      ...
      foreach ($menus as $key => $label) {
          $active = $key === $page ? 'bg-blue-500 text-white' : 'hover:bg-blue-100 dark:hover:bg-gray-700';
