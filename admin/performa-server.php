...
function get_country($domain) {
    ...
    $info = @file_get_contents("https://ipinfo.io/{$ip}/country");
    return $info ? trim($info) : 'Tidak Diketahui';
}
...
<body class="bg-gray-900 text-white min-h-screen p-4 md:p-6">
    ...
    <div class="max-w-5xl mx-auto bg-gray-800 rounded-lg p-4 md:p-6 shadow-lg">
        <h1 class="text-xl md:text-2xl font-semibold mb-4 text-center">Status WebSocket Inject Tunneling Server Tokomard</h1>
        ...
        <p class="text-xs text-gray-400 mt-4 text-center">
            * Status Injek connect atau tidak untuk setiap server ditentukan dari respon WebSocket handshake 101 Switching Protocols. <br>
