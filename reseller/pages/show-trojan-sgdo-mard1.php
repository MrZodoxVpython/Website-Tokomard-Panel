...
<div class="max-w-5xl mx-auto">
    <h1 class="text-2xl font-bold text-center mb-6">Daftar Akun Trojan RW-MARD1 - <?= htmlspecialchars($reseller) ?></h1>
...
root@ubuntu-s-4vcpu-16gb-amd-sgp1-01:/var/www/html/Website-Tokomard-Panel/reseller/pages# cat show-trojan-rw-mard.php
<?php
error_reporting(E_ALL);
ini_set('display_errors', 1);
session_start();
