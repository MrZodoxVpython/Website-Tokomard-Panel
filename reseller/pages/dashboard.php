...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-white">
  ...
  <div class="min-h-screen w-full px-4 py-6 mx-auto overflow-x-hidden">
    ...
    <!-- Statistik -->
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 mb-6 w-full">
      <?php
      foreach (['total' => 'Total Akun', 'vmess' => 'VMess', 'vless' => 'VLess', 'trojan' => 'Trojan', 'shadowsocks' => 'Shadowsocks'] as $k => $label) {
          ...
          echo "<div class='bg-{$color}-500 text-white p-4 rounded-lg shadow text-center'>
    ...
    <!-- Grafik -->
    <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow w-full mb-8">
    ...
    <!-- Tabel -->
    <div class="overflow-x-auto rounded-lg border border-gray-300 dark:border-gray-700 shadow w-full">
      <table class="w-full min-w-[640px] text-sm text-left text-gray-700 dark:text-white">
