...
if (isset($_POST['toggle_user']) && isset($_POST['action'])) {
    ...
    header("Location: show-vless-sgdo-mard1.php");
    exit;
}
...
<head>
    <meta charset="UTF-8">
    <title>Vless SGDO-MARD1</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-900 text-white min-h-screen p-6">
<div class="max-w-5xl mx-auto">
    <h1 class="text-center text-2xl font-bold mb-6">Daftar Vless (SGDO-MARD1) – <?=htmlspecialchars($reseller)?></h1>
