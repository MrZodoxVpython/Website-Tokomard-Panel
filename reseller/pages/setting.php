...
<div class="flex flex-col md:flex-row items-center md:items-start gap-4 mb-10">
  <!-- Box Profil -->
  <div class="bg-gray-800 rounded-lg p-5 w-full pb-10 md:w-1/3 text-center shadow border border-gray-700 overflow-hidden">
...
<!-- Riwayat Transaksi -->
<!-- Riwayat Transaksi -->
<div class="bg-gray-800 p-4 -mt-7 rounded-lg shadow border max-w-full border-gray-700">
